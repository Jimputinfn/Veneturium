...
namespace SharpBrowser.Browser {
	internal static class BrowserConfig {
		...
		public static string Branding = "Veneturium Browser";
		public static string AcceptLanguage = "en-US,en;q=0.9";
		public static string UserAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.5112.102 Safari/537.36 /CefSharp Browser" + Cef.CefSharpVersion; // UserAgent to fix issue with Google account authentication		
		...
		public static string CannotConnectURL = "veneturium://storage/errors/cannotConnect.html";
		public static string SearchURL = "https://duckduckgo.com/?t=h_&q=";
